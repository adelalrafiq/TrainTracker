...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrainTracker.Api.Data.Models.DelayRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TrainTracker.Api.Data.Models.Station", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TrainTracker.Api.Data.Models.Train", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TrainTracker.Api.Data.Models.Trip", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TrainTracker.Api.Data.Models.DelayRecord", b =>
                {
                    b.HasOne("TrainTracker.Api.Data.Models.Trip", "Trip")
                        .WithMany("Delays")
            ...
            modelBuilder.Entity("TrainTracker.Api.Data.Models.Trip", b =>
                {
                    b.HasOne("TrainTracker.Api.Data.Models.Station", "ArrivalStation")
                        .WithMany("ArrivalTrips")
                        .HasForeignKey("ArrivalStationId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("TrainTracker.Api.Data.Models.Station", "DepartureStation")
                        .WithMany("DepartureTrips")
                        .HasForeignKey("DepartureStationId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("TrainTracker.Api.Data.Models.Train", "Train")
                        .WithMany("Trips")
